...
c --------------------------------------------------------------
      ...
      call rddate ! synoptic time stuck on top of namelist
...
ccccc+                               //c_idt(1:6)
     ...
     +                               //c_lon(1:6)           ! longitude
      ...
      !print*,csort_wbad(iob)
      !print'(8f8.2)',hdr(iob,2:9)
      !if(iob<21) print*,'0 ',drinfo(iob,:) 
      if(iob<21) print'(a8,8f8.2)',hdr(iob,1:8) 
